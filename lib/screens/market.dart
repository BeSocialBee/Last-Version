                              ...
                              return Padding(
                                ...
                                child: GridView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    if (!countdownControllers.containsKey(card['documentID'])) {
                                      countdownControllers[card['documentID']] = StreamController<num>();
                                    }
                                    return AuctionCardWidget(
                                      ...
                                      token: token,
                                      countdownStreamController: countdownControllers[card['documentID']]!,
                                    );
                                  },
                                ),
                              );
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    AuctionScreenWidget(documentID: widget.documentID!)));
      },
      child: Container(
        height: 800,
        child: Card(
